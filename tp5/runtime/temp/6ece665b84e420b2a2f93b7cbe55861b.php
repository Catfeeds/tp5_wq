<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"/home/wwwroot/default/hejiang/addons/hc_step/tp5/public/../app/admin/view/login/login.html";i:1540368877;s:89:"/home/wwwroot/default/hejiang/addons/hc_step/tp5/public/../app/admin/view/layout/top.html";i:1540368877;s:92:"/home/wwwroot/default/hejiang/addons/hc_step/tp5/public/../app/admin/view/layout/bottom.html";i:1540368877;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title>高原圣果</title>
   <!--   <title>高原圣果 <?php if(!(empty($ob_title) || (($ob_title instanceof \think\Collection || $ob_title instanceof \think\Paginator ) && $ob_title->isEmpty()))): ?> | <?php echo $ob_title; endif; ?></title> -->
...
<div class="admin-login-box">
  <div class="login-logo">
      <a href="" class="login-logo-a"><b>高原圣果</b></a>
  </div>
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo url('loginHandle'); ?>" method="post" class="admin-login-form">
      ...
      <div class="row">
       ...
       <button class="btn btn-block btn-google btn-flat" style="background-color: #3b5998" >
              <span class="ladda-label"><a href="<?php echo url('member_add'); ?>" style="display:block; color: #fff">注册</a></span>
          </button>
