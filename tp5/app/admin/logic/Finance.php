...
class Finance extends AdminBase{
    ...
    public function getBonusList($date, $username){
        ...
        $field = 'b.times_id,t.date,sum(b.b0) as b0,sum(b.b1) as b1,sum(b.b2) as b2,sum(b.b3) as b3,sum(b.b4) as b4,sum(b.b5) as b5,sum(b.b6) as b6,sum(b.b7) as b7,sum(b.b8) as b8,sum(b.b9) as b9';
...
//var_dump($list[0]);die;
        ...
        $field = 'sum(b.b0) as b0,sum(b.b1) as b1,sum(b.b2) as b2,sum(b.b3) as b3,sum(b.b4) as b4,sum(b.b5) as b5,sum(b.b6) as b6,sum(b.b7) as b7,sum(b.b8) as b8,sum(b.b9) as b9';
        $sum = $this->modelBonus
            ->alias('b')
            ->field($field)
            ->where($where)
    ...
    public function getBonusList2($times_id, $username){
        ...
        //   $where=array_remove($where,'username');
        // }
        ...
        $field = 'sum(b0) as b0,sum(b1) as b1,sum(b2) as b2,sum(b3) as b3,sum(b4) as b4,sum(b5) as b5,sum(b6) as b6,sum(b7) as b7,sum(b8) as b8,sum(b9) as b9';
    ...
    public function getBonusList3($times_id, $username){
        ...
        // }
           ...
           $where ['action_type']= ['in', [1,2,3,4,5,6,7,8,9,66]];
